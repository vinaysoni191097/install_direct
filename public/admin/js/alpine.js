            ...
            Object.entries(Gt).forEach(([r, n]) => {
                Object.defineProperty(e, `$${r}`, {
                    get() {
                        let [i, o] = at(t);
                        return (
                            (i = { interceptor: be, ...i }), _e(t, o), n(t, i)
                        );
                    },
                    enumerable: !1,
                });
...
`
    ...
    function On(e, t, r) {
        ...
        t.includes("in") &&
            !n &&
            (t = t.filter((h, b) => b < t.indexOf("out"))),
            t.includes("out") &&
                !n &&
                (t = t.filter((h, b) => b > t.indexOf("out")));
    ...
    x(
        "refs",
        (e) => (
            e._x_refs_proxy || (e._x_refs_proxy = D(pi(e))), e._x_refs_proxy
        )
    );
    function pi(e) {
        let t = [],
    ...
    function gi(e, t) {
        ...
        if (r.includes("debounce")) {
            ...
            r.splice(
                o,
                kt((r[o + 1] || "invalid-wait").split("ms")[0]) ? 2 : 1
            );
        }
        ...
        r((s) => {
            ...
            if (i(s))
                s = Object.entries(s).map(([f, h]) => {
                    let b = on(t, h, f, s);
                    n((v) => u.push(v), { scope: { index: f, ...b } }),
                        l.push(b);
                });
            else
                for (let f = 0; f < s.length; f++) {
                    let h = on(t, s[f], f, s);
                    n((b) => u.push(b), { scope: { index: f, ...h } }),
                        l.push(h);
                }
            let p = [],
                y = [],
