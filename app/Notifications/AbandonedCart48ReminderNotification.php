...
class AbandonedCart48ReminderNotification extends Notification
{
    use Queueable;
    ...
    public function __construct($user)
    {
        ...
        $this->emailTemplate = EmailTemplate::where('template_used_for', EmailTemplate::ABANDONMENT_CART_48_HOURS)->first();
