    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">{{ __('Edit Partner logo') }}</h4>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="grid  grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                        <div class="col-span-full">
                            <label for="street-question"
                                class="block text-sm  leading-6 text-black font-bold">{{ __('Partner Name') }}
                                <sup class="text-red-600">*</sup>
                            </label>
                            <div class="mt-2">
                                <input type="text" value="{{ $logo->partner_name }}" id="partner_name"
                                    name="partner_name" required maxlength="250"
                        ...
                        <div class="col-span-full">
                            <div class="mb-3">
                                ...
                                <input id="featured_image" value="{{ $logo->partnerLogo->path }}" name="featured_image"
                                    type="file" style="display: block;" onchange="fileChosen(event)"
                                    accept="image/x-png,image/gif,image/jpeg">

                                <div class="image-preview-container relative mt-2 w-2/6">
                                    <div id="closeImagePreview"
                                        class="close-icon hidden absolute w-3/4 text-red-500 font-extrabold text-xl cursor-pointer right-1 ">
                                        &times;
                                    </div>
                                    <img class="w-32 h-full object-contain" id="featuredImage"
                                        src="{{ asset('storage/' . $logo->partnerLogo->path) }}" alt="Uploaded Image" />
                                </div>
                            </div>
                    ...
                    <div class="flex items-center justify-end gap-x-6 border-t border-gray-900/10  py-4 mt-10">
                        <a href="{{ route('admin.logos') }}" type="button"
