...
@section('content')
    ...
    <div class="space-y-10 divide-y divide-gray-900/10">
        <div class="grid grid-cols-1 gap-x-8 gap-y-8 pt-2 md:grid-cols-3">
            <form action="{{ route('admin.team.member.update', $member) }}" method="post" enctype="multipart/form-data"
                ...
                <div class="px-4 py-6 sm:p-8">
                    <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" name="first_name" value="{{ $member->first_name }}" id="first_name"
                                    required
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" name="last_name" value="{{ $member->last_name }}" id="last_name"
                                    required
                                    class="block w-full rounded-md border-1 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" name="phone" value="{{ $member->phone_number }}" required
                                    maxlength="15"
                                    class="block w-full rounded-md border-1 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <input type="text" value="{{ $member->designation }}" id="designation"
                                    name="designation" required maxlength="50"
                                    class="block w-full rounded-md border-1 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <textarea id="description" name="description" required rows="3" maxlength="100"
                                    class="block w-full rounded-md border-1 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ $member->description }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                @if ($member->profile_picture)
                                    <img class="inline-block w-32 h-32  shadow border border-white mt-2"
                                        src="{{ asset('storage/' . $member->profile_picture) }}" name="product_image"
                                        value="{{ $member->profile_picture }}" id="profile-image" alt="">
                                @else
                                    <img class="inline-block w-32 h-32  shadow border border-white mt-2"
                        ...
                        <div class="sm:col-span-2 sm:col-start-1">
                            ...
                            <div class="mt-2">
                                <input name="linkedIn_url" type="text" value="{{ $member->linkedIn_url }}"
                                    id="linkedIn_url"
                                    class="block w-full rounded-md border-1 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <input type="text" value="{{ $member->twitter_url }}" id="twitter_url"
                                    name="twitter_url"
                                    class="block w-full rounded-md border-1 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
