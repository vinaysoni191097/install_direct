...
@section('content')
    <main class="pt-16 md:pt-[96px] space-y-8">
        <div class="tab-wrapper" x-data="{ activeTab: 0 }" x-cloak>
            <div class="footer-bg ">
            ...
            <section class="mx-auto max-w-6xl lg:max-w-8xl px-4 lg:px-8 md:mt-20 mt-10 mb-20  h-full">
                                            ...
                                            <div class="min-w-0 flex-1">
                                                ...
                                                <div class="flex items-center gap-5">
                                                    ...
                                                    <p class="mt-1 text-base">
                                                        <span class="text-gray-400">Booking
                                                            Amount</span>
                            ...
                            <div class="space-y-3 p-3 border rounded-md border-secondary-200">
                                ...
                                <a href="{{ route('customer.order.details', $order) }}">
                                    <div class="md:flex flex-col sm:flex-row gap-3 mt-2">
                                        ...
                                        <div class="sm:ml-6 md:flex flex-1 flex-col ">
                                            <div class="md:flex text-center md:text-left">
                                                <div class="min-w-0 flex-1">
                                                    <div class="text-gray-400 text-base font-medium">
                                                        {{ $order->created_at->format('d M Y (l)') }}</div>
                                                    <h3 class="text-sm md:flex gap-4 py-2 items-center">
                                                        <p class="md:text-2xl text-lg font-bold mb-2 md:mb-0">
                                                    ...
                                                    <div class="md:flex items-center gap-5 mb-2">
                                                ...
                                                <div
                                                    class="flow-root flex-shrink-0 text-2xl font-semibold text-secondary-600">
                ...
                <form action="{{ route('customer.profile.default.address') }}" method="post" id="defaultAddressForm">
                    @csrf
                    <div class="tab-panel" :class="{ 'active': activeTab === 2 }"
                        ...
                        <div class="md:flex justify-between items-end">
                            <div>
                                ...
                                <div class="md:text-lg text-base text-gray-500">Update and manage your addresses here.
                                </div>
                            </div>
                                ...
                                <div class="border rounded w-full px-8">
                                    <div class="mt-5 flex  gap-3  p-3 text-sm relative">
                                        @if ($address->id == $user->userData->default_address_id)
                                            <p
                                                class="bg-green-600 text-white items-center w-16 h-5 text-center rounded-lg ">
                                                Default</p>
                                        @else
                                            <input type="radio"
                                    ...
                                    <div class="flex gap-5 px-10 mb-5">
                                        <a href="{{ route('customer.edit.address', $address->id) }}"
                                            class="text-green-600 font-medium text-base">Edit</a>
                ...
                <div class="mt-9">
                    <a href="{{ route('customer.profile.address') }}" class="text-green-600 text-xl font-semibold block">
                        + Add new Address
                    </a>
                </div>
        </div>
