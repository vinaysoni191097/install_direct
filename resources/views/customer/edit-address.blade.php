        ...
        <div class="tab-wrapper" x-data="{ activeTab: 2 }" x-cloak>
            ...
            <section class="mx-auto max-w-6xl lg:max-w-8xl px-4 lg:px-8 md:mt-20 mt-10 mb-20  h-full">
                <div class="tab-panel" :class="{ 'active': activeTab === 0 }"
                    ...
                    <form action="{{ route('customer.profile.update', $user) }}" method="post" id="userRegistrationForm"
                            ...
                            <div class="space-y-3 p-3 border rounded-md border-secondary-200">
                                ...
                                <div class="md:flex flex-col sm:flex-row gap-3 mt-2">
                                    <div class="flex-shrink-0 m-auto w-28 h-28">
                                        <img src="{{ asset('images/panel.png') }}" alt="Product image"
                ...
                <div class="tab-panel" :class="{ 'active': activeTab === 2 }"
                    ...
                    <form action="{{ route('customer.address.update', $address->id) }}" method="post"
                        ...
                        <div class="mt-2 md:w-1/2 grid  grid-cols-1 gap-y-3 sm:grid-cols-2 sm:gap-x-4 ">
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-1">
                                    <input type="text" name="shippingFullName"
                                        ...
                                        placeholder="Jane Doe" value="{{ $address->new_address_full_name }}">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <select id="state" name="state"
                                        class="block w-full py-3 px-4 border border-secondary-200 rounded-md placeholder:text-sm placeholder:text-secondary-500 mb-2">
                                        <option value="" selected disabled>{{ $address->state }}</option>
                                        <option value="1">England
                                        </option>
                                        <option value="2">Scotland
                                        </option>
                                        <option value="3">Wales
                                        </option>
                                    </select>
                                    @error('state')
                                        <p class="text-red-600 font-semibold mt-2">{{ $message }}</p>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-1">
                                    <input type="text" name="country" id="country" disabled
                                        ...
                                        placeholder="Phone number" value="UK">
                                    @error('country')
                                        <p class="text-red-600 font-semibold mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="sm:col-span-2">
                                <label for="zip" class="block text-secondary-600">Zip Code</label>
                                <div class="mt-1">
                                    <input type="text" name="zip" id="zip"
                                        class="block w-full py-3 px-4 border border-secondary-200 rounded-md placeholder:text-sm placeholder:text-secondary-500 mb-2"
                                        placeholder="Enter postal code" value="{{ $address->zip }}">
                                    @error('zip')
                                        <p class="text-red-600 font-semibold mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-1">
                                    <textarea name="shippingAddress2"
                                        ...
                                        placeholder="123 Main Street, London, NW1 2AB, United Kingdom">{{ $address->address }}</textarea>
